...
def runner(path, bundle_prefix, max_x, max_y, max_y_infections,
    ...
    if os.path.exists(detected_path):
        ...
        sims = [sim_filter_detected, sim_filter_infected, sim_filter_x, sim_filter_x_slide]
        arrays = [detections_, infections_, detections_reverse_time_, detections_reverse_time_slide_]
